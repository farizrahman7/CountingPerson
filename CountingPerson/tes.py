...
# Memuat model YOLOv8
model = YOLO("yolov8n.pt")  # Menggunakan model YOLOv8 kecil untuk kecepatan, bisa memilih model lain
...
while True:
    ...
    persons = [result for result in results if result['class'] == 'person']
    ...
    for person in persons:
        ...
        cv2.putText(frame, "person", (bbox[0], bbox[1] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (36, 255, 12), 2)
